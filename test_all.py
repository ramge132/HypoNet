...
def train_and_test(model_name, root_dir, resize_size, dataset_paths, transform_train, transform_test):
    ...
    # 데이터셋 및 데이터로더 정의
    dataset = CustomCIFAR10Dataset(root_dir=root_dir, transform=transform_train)
    ...
    for epoch in range(1, 51):
        ...
        epoch_loss = 0.0
        epoch_corrects = 0
        for inputs, labels in tqdm(loader, desc=f"Epoch {epoch}"):
        ...
        print('Training Loss:', epoch_loss / len(loader.dataset))
        print('Training Accuracy:', epoch_corrects.double() / len(loader.dataset))
    ...
    for dataset_path in dataset_paths:
        ...
        test_dataset = CustomCIFAR10Dataset(root_dir=dataset_path, transform=transform_test)
...
train_and_test('ResNet-18', root_dir, 32, [dataset_paths[0]], transform_32, transform_32_test)
train_and_test('ResNet-18', root_dir, 96, [dataset_paths[1]], transform_96, transform_96_test)
train_and_test('ResNet-18', root_dir, 224, [dataset_paths[2]], transform_224, transform_224_test)